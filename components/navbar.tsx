...
import { HardHatIcon, MenuIcon, XIcon, UserIcon, FileIcon, PackageIcon, DollarSignIcon } from 'lucide-react';
...
export function Navbar() {
  ...
  return (
    <nav className="flex items-center justify-between p-4 bg-gray-300 shadow-md fixed w-full z-10">
